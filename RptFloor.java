...
class RptFloor extends JFrame implements ActionListener
{
	//int w = 3020;
	ReportScreen ES;
	...
	RptFloor()
	{
		...
		lblProgrammeHeading.setText("Floor Report..");
   ...
   public void actionPerformed(ActionEvent ae)
   {
	...
	void setColumnsWidth()
	{
		...
		tool.setColumnWidth("FloorName",180);
		tool.setColumnWidth("TotalRooms",180);
	...
	void setColumnsData()
	{
		...
		for(int i=0;i<Data.length;i++)
		{
			...
			Objectdata[3]=ClsRoom.getAllRecordsCountFloorWise(Data[i].getFloorID());
