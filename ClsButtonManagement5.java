...
public class ClsButtonManagement5
{
	...
	void manageFourthCombo(JComboBox cmbFourth)
	{
		this.cmbFourth=cmbFourth;
	}
	void manageFourthPanel(JPanel pnlFourth)
	{
		this.pnlFourth=pnlFourth;
	}
	void manageFourthLabel(JLabel lblFourth)
	{
		this.lblFourth=lblFourth;
	}


	void manageFiveCombo(JComboBox cmbFive)
	{
		this.cmbFive=cmbFive;
	}
	void manageFivePanel(JPanel pnlFive)
	{
		this.pnlFive=pnlFive;
	}
	void manageFiveLabel(JLabel lblFive)
	{
		this.lblFive=lblFive;
	}
	...
	void showButtonsOnUI(ButtonState bst)
	 {
		...
		else if(bst.getButtonState()==ButtonState.UpdateState)
		{
			...
			PanelState.disabledComponents(pnlFourth);
			PanelState.disabledComponents(pnlFive);
...
void rejectAction()
	...
	void resetAllCombo()
	{
		...
		cmbFourth.removeAllItems();
		cmbFourth.addItem("No Records...");
		lblFourth=new JLabel("-----------------");
		PanelState.disabledComponents(pnlFourth);


		cmbFive.removeAllItems();
		cmbFive.addItem("No Records...");
		lblFive=new JLabel("-----------------");
		PanelState.disabledComponents(pnlFive);
